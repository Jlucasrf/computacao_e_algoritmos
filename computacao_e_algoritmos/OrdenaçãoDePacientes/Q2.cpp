...
- O Bubble Sort seria mais eficiente se a lista estiver quase ordenada.O Bubble Sort possui uma otimização natural, onde, se em uma passagem completa não houver trocas, ele entende que a lista já está ordenada e encerra antes de completar todos os ciclos,Isso faz com que o Bubble Sort, no melhor caso, tenha complexidade O(n) — extremamente rápido se a lista estiver quase ordenada.
*/
